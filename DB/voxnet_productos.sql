...
CREATE TABLE `productos` (
  ...
  `disponibilidadProducto` tinyint(1) NOT NULL,
  `idCategoriaProducto` int NOT NULL,
  PRIMARY KEY (`idProductos`),
  KEY `idCategoriaProducto` (`idCategoriaProducto`),
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`idCategoriaProducto`) REFERENCES `categorias` (`idCategoriaProducto`)
...
-- Dump completed on 2024-07-08 16:45:57
